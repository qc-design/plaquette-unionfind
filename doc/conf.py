...
autodoc_mock_imports = ["plaquette_unionfind_bindings"]
...
author = "It'sQ GmbH"
url = "https://docs.plaquette.design/project/unionfind"
...
exhale_args = {
    ...
    "exhaleDoxygenStdin": (
        "INPUT = "
        "../plaquette_unionfind/src/UnionFindDecoder.hpp "
        "../plaquette_unionfind/src/Clusters.hpp "
        "../plaquette_unionfind/src/ClusterBoundary.hpp "
        "EXCLUDE_SYMBOLS = std::* "
    ),
...
release = plaquette_unionfind.__version__
...
html_theme = "furo"
html_theme_options = {
    "source_repository": "https://github.com/qc-design/plaquette-unionfind/",
    "source_branch": "main",
